package advancedChemistry.common.container;
...
public class ContainerAnalyzer extends Container {
        ...
        protected TileAnalyzer tileEntity;

        public ContainerAnalyzer (InventoryPlayer inventoryPlayer, TileAnalyzer te){
                tileEntity = te;
                
                addSlotToContainer(new Slot(tileEntity, 0, 30, 34));
