...
public class CapsuleChemical extends Item {
	public CapsuleChemical(int par1, int par2) {
		super(par1);
		this.setHasSubtypes(true);
		this.setMaxDamage(0);
		this.setContainerItem(AdvancedChemistry.EmptyCapsule);
	...
	public String getItemNameIS(ItemStack par1) {
		...
		return DataStorage.element[var1].Name + "_capsule";
	}
	...
	public void getSubItems(int par1, CreativeTabs par2CreativeTabs,
		...
		for (int var4 = 1; var4 <= DataStorage.CurrentChemicals; ++var4) {
			if ((DataStorage.element[var4].Metal == 1)
					&& (DataStorage.element[var4].Stability == 3)) {
